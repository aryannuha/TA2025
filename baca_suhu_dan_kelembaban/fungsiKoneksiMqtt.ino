...
void sendData(){
  // Kirim ke MQTT
  // client.publish("esp32/suhu", datasuhu_Str, true);  // Kirim dalam bentuk string
  // client.publish("esp32/kelembaban", datakelembaban_Str, true);  // Kirim dalam bentuk string
